...
st.markdown("<h1 style='text-align: center; color: #d69e2e; font-weight: 700; margin-bottom: 25px;'>🌾 لوحة المؤشرات والتحليلات التفاعلية - صوامع طامية</h1>", unsafe_allow_html=True)
